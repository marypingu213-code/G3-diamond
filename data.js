const allLessonsData = {
    ...
    "4": { 
        ...
        level3: [
            ...
            { text: "看到好朋友受傷了，他的________充滿了擔心。", answer: "眼神" },
            { text: "小明跑步很快，躲避球的________也非常快。", answer: "反應" },
            { text: "以前的人如果被欺負，會去________找官員幫忙。", answer: "官府" },
            { text: "諸葛亮是古代很有名的________，他非常聰明。", answer: "丞相" },
            { text: "比賽結束後，我要趕快回教室向老師________比分。", answer: "回報" },
            // --- 挑戰版題目 (9-17) ---
            { text: "爸爸下個月要到國外________兩週，雖然我們很不捨，但還是祝他工作順利。", answer: "出差" },
            { text: "這位小運動員的________非常靈敏，一聽到槍聲就立刻衝出起跑線。", answer: "反應" },
            { text: "看到原本乾淨的牆壁被弟弟塗鴉，媽媽露出了非常________的表情。", answer: "吃驚" },
            { text: "古代遇到重大案件時，百姓通常會前往________請官員主持公道。", answer: "官府" },
            { text: "弟弟長高了不少，頭頂都快要碰到家裡的________了。", answer: "門框" },
            { text: "老師從他的________中，看出了他對這題答案的自信與堅定。", answer: "眼神" },
            { text: "在三國故事中，諸葛亮是一位非常有智慧的________，幫助劉備管理國家。", answer: "丞相" },
            { text: "辛苦工作了一天，這碗濃郁香甜的________是妹妹最喜歡的點心。", answer: "奶酪" },
