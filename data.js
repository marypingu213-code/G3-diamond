const allLessonsData = {
    ...
    "4": { 
        title: "第四課：揚修猜字", 
        level1: [
            { word: "闊", parts: ["images/L4/筆順-闊-部件-1.png", "images/L4/筆順-闊-部件-2.png", "images/L4/筆順-闊-部件-3.png", "images/L4/筆順-闊-部件-4.png"], pos: [{x: 90, y: 130, scale: 1.3}, {x: 150, y: 130, scale: 0.5}, {x: 90, y: 180, scale: 0.5}, {x: 150, y: 180, scale: 0.5}] },
    ...
    "5": { 
        title: "第五課：唱反調", 
        level1: [
            // 🌟 鞠(5)：1、2 小 (0.7)，4 大 (1.3)
            { word: "鞠", parts: ["images/L5/筆順-鞠-部件-1.png", "images/L5/筆順-鞠-部件-2.png", "images/L5/筆順-鞠-部件-3.png", "images/L5/筆順-鞠-部件-4.png", "images/L5/筆順-鞠-部件-5.png"], pos: [{x: 50, y: 180, scale: 0.7}, {x: 90, y: 180, scale: 0.7}, {x: 130, y: 180}, {x: 170, y: 180, scale: 1.3}, {x: 210, y: 180}] },
            // 躬(2)
            ...
            // 🌟 厲(5)：修正為 5 個部件！(預設排列)
            { word: "厲", parts: ["images/L5/筆順-厲-部件-1.png", "images/L5/筆順-厲-部件-2.png", "images/L5/筆順-厲-部件-3.png", "images/L5/筆順-厲-部件-4.png", "images/L5/筆順-厲-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180}, {x: 130, y: 180}, {x: 170, y: 180}, {x: 210, y: 180}] },
            // 🌟 鬥(4)：2、4 大 (1.3)
            { word: "鬥", parts: ["images/L5/筆順-鬥-部件-1.png", "images/L5/筆順-鬥-部件-2.png", "images/L5/筆順-鬥-部件-3.png", "images/L5/筆順-鬥-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 1.3}, {x: 90, y: 180}, {x: 150, y: 180, scale: 1.3}] },
            // 🌟 千(2)：2 大 (1.3)
            { word: "千", parts: ["images/L5/筆順-千-部件-1.png", "images/L5/筆順-千-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180, scale: 1.3}] },
            // 🌟 普(5)：2、5 小 (0.7)
            { word: "普", parts: ["images/L5/筆順-普-部件-1.png", "images/L5/筆順-普-部件-2.png", "images/L5/筆順-普-部件-3.png", "images/L5/筆順-普-部件-4.png", "images/L5/筆順-普-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180, scale: 0.7}, {x: 130, y: 180}, {x: 170, y: 180}, {x: 210, y: 180, scale: 0.7}] },
            // 🌟 睜(4)：2、3、4 小 (0.7)
            ...
            // 🌟 錢(3)：修正為 3 個部件！(預設排列)
            { word: "錢", parts: ["images/L5/筆順-錢-部件-1.png", "images/L5/筆順-錢-部件-2.png", "images/L5/筆順-錢-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180}, {x: 170, y: 180}] },
            // 🌟 偏(4)：3、4 小 (0.7)
            { word: "偏", parts: ["images/L5/筆順-偏-部件-1.png", "images/L5/筆順-偏-部件-2.png", "images/L5/筆順-偏-部件-3.png", "images/L5/筆順-偏-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130}, {x: 90, y: 180, scale: 0.7}, {x: 150, y: 180, scale: 0.7}] },
            // 🌟 察(4)：1 大 (1.3)
            ...
            // 🌟 偷(5)：3、4、5 小 (0.7)
            { word: "偷", parts: ["images/L5/筆順-偷-部件-1.png", "images/L5/筆順-偷-部件-2.png", "images/L5/筆順-偷-部件-3.png", "images/L5/筆順-偷-部件-4.png", "images/L5/筆順-偷-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180}, {x: 130, y: 180, scale: 0.7}, {x: 170, y: 180, scale: 0.7}, {x: 210, y: 180, scale: 0.7}] },
            // 🌟 胡(3)：1、2 小 (0.7)
