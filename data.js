const allLessonsData = {
    ...
    "4": { 
        ...
        level1: [
            ...
            // 🌟 丞(4)：部件2, 3 小一點 (0.7)
            { word: "丞", parts: ["images/L4/筆順-丞-部件-1.png", "images/L4/筆順-丞-部件-2.png", "images/L4/筆順-丞-部件-3.png", "images/L4/筆順-丞-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.7}, {x: 90, y: 180, scale: 0.7}, {x: 150, y: 180}] },
            // 🌟 曹(4)：部件4 小一點 (0.7)
            ...
            // 🌟 楊(4)：部件2, 4 小一點 (0.7)
            { word: "楊", parts: ["images/L4/筆順-楊-部件-1.png", "images/L4/筆順-楊-部件-2.png", "images/L4/筆順-楊-部件-3.png", "images/L4/筆順-楊-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.7}, {x: 90, y: 180}, {x: 150, y: 180, scale: 0.7}] },
            // 🌟 修(4)：部件2, 3, 4 小一點 (0.7)
            { word: "修", parts: ["images/L4/筆順-修-部件-1.png", "images/L4/筆順-修-部件-2.png", "images/L4/筆順-修-部件-3.png", "images/L4/筆順-修-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.7}, {x: 90, y: 180, scale: 0.7}, {x: 150, y: 180, scale: 0.7}] },
            // 🌟 智(3)：部件2 小一點 (0.7)
            ...
            // 🌟 應(4)：部件2, 3 小一點 (0.7)
            { word: "應", parts: ["images/L4/筆順-應-部件-1.png", "images/L4/筆順-應-部件-2.png", "images/L4/筆順-應-部件-3.png", "images/L4/筆順-應-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.7}, {x: 90, y: 180, scale: 0.7}, {x: 150, y: 180}] },
            // 🌟 官(2)：部件2 小一點 (0.7)
            { word: "官", parts: ["images/L4/筆順-官-部件-1.png", "images/L4/筆順-官-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180, scale: 0.7}] },
            // 🌟 府(3)：部件1 大一點 (1.4)
            { word: "府", parts: ["images/L4/筆順-府-部件-1.png", "images/L4/筆順-府-部件-2.png", "images/L4/筆順-府-部件-3.png"], pos: [{x: 70, y: 180, scale: 1.4}, {x: 120, y: 180}, {x: 170, y: 180}] },
            // 🌟 差(3)：部件2 小一點 (0.7)
            ...
            // 🌟 報(5)：部件2, 3 小一點 (0.7)
            { word: "報", parts: ["images/L4/筆順-報-部件-1.png", "images/L4/筆順-報-部件-2.png", "images/L4/筆順-報-部件-3.png", "images/L4/筆順-報-部件-4.png", "images/L4/筆順-報-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180, scale: 0.7}, {x: 130, y: 180, scale: 0.7}, {x: 170, y: 180}, {x: 210, y: 180}] },
            // 🌟 闊(4)：部件2, 3, 4 小一點 (0.7)
            { word: "闊", parts: ["images/L4/筆順-闊-部件-1.png", "images/L4/筆順-闊-部件-2.png", "images/L4/筆順-闊-部件-3.png", "images/L4/筆順-闊-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.7}, {x: 90, y: 180, scale: 0.7}, {x: 150, y: 180, scale: 0.7}] },
            // 🌟 酪(3)：部件2, 3 小一點 (0.7)
            { word: "酪", parts: ["images/L4/筆順-酪-部件-1.png", "images/L4/筆順-酪-部件-2.png", "images/L4/筆順-酪-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180, scale: 0.7}, {x: 170, y: 180, scale: 0.7}] },
            // 🌟 驚(4)：部件2, 3 小一點 (0.7)
            { word: "驚", parts: ["images/L4/筆順-驚-部件-1.png", "images/L4/筆順-驚-部件-2.png", "images/L4/筆順-驚-部件-3.png", "images/L4/筆順-驚-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.7}, {x: 90, y: 180, scale: 0.7}, {x: 150, y: 180}] }
        ], 
        level2: [], 
        level3: [], 
        level4: [] 
