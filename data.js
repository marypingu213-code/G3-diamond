const allLessonsData = {
    ...
    "6": { 
        ...
        level1: [
            // 🌟 第六課生字匯入！(均為預設標準排列)
            { word: "村", parts: ["images/L6/筆順-村-部件-1.png", "images/L6/筆順-村-部件-2.png", "images/L6/筆順-村-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180}, {x: 170, y: 180}] },
            { word: "猴", parts: ["images/L6/筆順-猴-部件-1.png", "images/L6/筆順-猴-部件-2.png", "images/L6/筆順-猴-部件-3.png", "images/L6/筆順-猴-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130}, {x: 90, y: 180}, {x: 150, y: 180}] },
            { word: "抖", parts: ["images/L6/筆順-抖-部件-1.png", "images/L6/筆順-抖-部件-2.png", "images/L6/筆順-抖-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180}, {x: 170, y: 180}] },
            { word: "造", parts: ["images/L6/筆順-造-部件-1.png", "images/L6/筆順-造-部件-2.png", "images/L6/筆順-造-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180}, {x: 170, y: 180}] },
            { word: "助", parts: ["images/L6/筆順-助-部件-1.png", "images/L6/筆順-助-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            { word: "展", parts: ["images/L6/筆順-展-部件-1.png", "images/L6/筆順-展-部件-2.png", "images/L6/筆順-展-部件-3.png", "images/L6/筆順-展-部件-4.png", "images/L6/筆順-展-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180}, {x: 130, y: 180}, {x: 170, y: 180}, {x: 210, y: 180}] },
            { word: "簧", parts: ["images/L6/筆順-簧-部件-1.png", "images/L6/筆順-簧-部件-2.png", "images/L6/筆順-簧-部件-3.png", "images/L6/筆順-簧-部件-4.png", "images/L6/筆順-簧-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180}, {x: 130, y: 180}, {x: 170, y: 180}, {x: 210, y: 180}] },
            // 🌟 摔(6)：獨家 6 個部件並排縮小版型
            { word: "摔", parts: ["images/L6/筆順-摔-部件-1.png", "images/L6/筆順-摔-部件-2.png", "images/L6/筆順-摔-部件-3.png", "images/L6/筆順-摔-部件-4.png", "images/L6/筆順-摔-部件-5.png", "images/L6/筆順-摔-部件-6.png"], pos: [{x: 40, y: 180, scale: 0.7}, {x: 80, y: 180, scale: 0.7}, {x: 120, y: 180, scale: 0.7}, {x: 160, y: 180, scale: 0.7}, {x: 200, y: 180, scale: 0.7}, {x: 240, y: 180, scale: 0.7}] },
            { word: "巨", parts: ["images/L6/筆順-巨-部件-1.png", "images/L6/筆順-巨-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            { word: "引", parts: ["images/L6/筆順-引-部件-1.png", "images/L6/筆順-引-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            { word: "觀", parts: ["images/L6/筆順-觀-部件-1.png", "images/L6/筆順-觀-部件-2.png", "images/L6/筆順-觀-部件-3.png", "images/L6/筆順-觀-部件-4.png", "images/L6/筆順-觀-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180}, {x: 130, y: 180}, {x: 170, y: 180}, {x: 210, y: 180}] },
            { word: "咦", parts: ["images/L6/筆順-咦-部件-1.png", "images/L6/筆順-咦-部件-2.png", "images/L6/筆順-咦-部件-3.png", "images/L6/筆順-咦-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130}, {x: 90, y: 180}, {x: 150, y: 180}] },
            { word: "松", parts: ["images/L6/筆順-松-部件-1.png", "images/L6/筆順-松-部件-2.png", "images/L6/筆順-松-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180}, {x: 170, y: 180}] },
            { word: "鼠", parts: ["images/L6/筆順-鼠-部件-1.png", "images/L6/筆順-鼠-部件-2.png", "images/L6/筆順-鼠-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180}, {x: 170, y: 180}] },
            { word: "混", parts: ["images/L6/筆順-混-部件-1.png", "images/L6/筆順-混-部件-2.png", "images/L6/筆順-混-部件-3.png", "images/L6/筆順-混-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130}, {x: 90, y: 180}, {x: 150, y: 180}] }
        ], 
        level2: [], 
        level3: [], 
        level4: [] 
