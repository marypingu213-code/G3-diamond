const allLessonsData = {
    ...
    "4": { 
        ...
        level1: [
            ...
            // 🌟 丞(4)：調整為部件1、4大一點 (1.3)，部件2、3保留小一點 (0.7)
            ...
            // 🌟 楊(4)：調整為部件2、3、4小一點 (0.6)
            { word: "楊", parts: ["images/L4/筆順-楊-部件-1.png", "images/L4/筆順-楊-部件-2.png", "images/L4/筆順-楊-部件-3.png", "images/L4/筆順-楊-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.6}, {x: 90, y: 180, scale: 0.6}, {x: 150, y: 180, scale: 0.6}] },
            // 修(4)：保留部件2、3、4小
            ...
            // 🌟 闊(4)：調整為外框的部件1、2大一點 (1.3)，裡面的部件3、4保留小一點 (0.7)
            { word: "闊", parts: ["images/L4/筆順-闊-部件-1.png", "images/L4/筆順-闊-部件-2.png", "images/L4/筆順-闊-部件-3.png", "images/L4/筆順-闊-部件-4.png"], pos: [{x: 90, y: 130, scale: 1.3}, {x: 150, y: 130, scale: 1.3}, {x: 90, y: 180, scale: 0.7}, {x: 150, y: 180, scale: 0.7}] },
            // 🌟 酪(3)：調整為部件2、3再小一點 (0.5)
            { word: "酪", parts: ["images/L4/筆順-酪-部件-1.png", "images/L4/筆順-酪-部件-2.png", "images/L4/筆順-酪-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180, scale: 0.5}, {x: 170, y: 180, scale: 0.5}] },
            // 🌟 驚(4)：部件2保留小(0.7)，部件3調整為大一點 (1.2)，部件4保留標準
            { word: "驚", parts: ["images/L4/筆順-驚-部件-1.png", "images/L4/筆順-驚-部件-2.png", "images/L4/筆順-驚-部件-3.png", "images/L4/筆順-驚-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.7}, {x: 90, y: 180, scale: 1.2}, {x: 150, y: 180}] }
        ], 
        level2: [], 
        level3: [], 
        level4: [] 
