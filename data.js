const allLessonsData = {
    ...
    "4": { 
        title: "第四課：揚修猜字", 
        level1: [
            // 🌟 闊(4)：調整部件2小(Standard 1.0)，部件3、4再次小一點 (0.5)，部件1大保留
            { word: "闊", parts: ["images/L4/筆順-闊-部件-1.png", "images/L4/筆順-闊-部件-2.png", "images/L4/筆順-闊-部件-3.png", "images/L4/筆順-闊-部件-4.png"], pos: [{x: 90, y: 130, scale: 1.3}, {x: 150, y: 130}, {x: 90, y: 180, scale: 0.5}, {x: 150, y: 180, scale: 0.5}] },
            // 🌟 驚(4)：調整部件3小(Standard 1.0)，部件2小保留
            { word: "驚", parts: ["images/L4/筆順-驚-部件-1.png", "images/L4/筆順-驚-部件-2.png", "images/L4/筆順-驚-部件-3.png", "images/L4/筆順-驚-部件-4.png"], pos: [{x: 90, y: 130}, {x: 150, y: 130, scale: 0.7}, {x: 90, y: 180}, {x: 150, y: 180}] },
            // 🌟 應(4)：調整部件1大一點 (1.4)，部件2、3小保留
