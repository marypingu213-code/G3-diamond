const allLessonsData = {
    ...
    "6": { 
        ...
        level1: [
            // 🌟 村：部件3 再更小一點 (0.5)
            { word: "村", parts: ["images/L6/筆順-村-部件-1.png", "images/L6/筆順-村-部件-2.png", "images/L6/筆順-村-部件-3.png"], pos: [{x: 70, y: 180}, {x: 120, y: 180}, {x: 170, y: 180, scale: 0.5}] },
            // 🌟 猴：部件3、4 小一點 (0.6)
            ...
            // 🌟 造：部件1、2 小一點 (0.6)
            { word: "造", parts: ["images/L6/筆順-造-部件-1.png", "images/L6/筆順-造-部件-2.png", "images/L6/筆順-造-部件-3.png"], pos: [{x: 70, y: 180, scale: 0.6}, {x: 120, y: 180, scale: 0.6}, {x: 170, y: 180}] },
            { word: "助", parts: ["images/L6/筆順-助-部件-1.png", "images/L6/筆順-助-部件-2.png"], pos: [{x: 100, y: 180}, {x: 170, y: 180}] },
            // 🌟 展：部件2、3、4、5 小一點 (0.6)
            { word: "展", parts: ["images/L6/筆順-展-部件-1.png", "images/L6/筆順-展-部件-2.png", "images/L6/筆順-展-部件-3.png", "images/L6/筆順-展-部件-4.png", "images/L6/筆順-展-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180, scale: 0.6}, {x: 130, y: 180, scale: 0.6}, {x: 170, y: 180, scale: 0.6}, {x: 210, y: 180, scale: 0.6}] },
            // 🌟 簧：部件4 小一點 (0.6)
            ...
            // 🌟 摔(6)：部件1 大一點 (1.2)，部件3、4、5 小一點 (0.5)
            ...
            // 🌟 觀：部件2、3 小一點 (0.6)，部件5 大一點 (1.3)
            { word: "觀", parts: ["images/L6/筆順-觀-部件-1.png", "images/L6/筆順-觀-部件-2.png", "images/L6/筆順-觀-部件-3.png", "images/L6/筆順-觀-部件-4.png", "images/L6/筆順-觀-部件-5.png"], pos: [{x: 50, y: 180}, {x: 90, y: 180, scale: 0.6}, {x: 130, y: 180, scale: 0.6}, {x: 170, y: 180}, {x: 210, y: 180, scale: 1.3}] },
            // 🌟 咦：部件1、2、3 小一點 (0.6)
